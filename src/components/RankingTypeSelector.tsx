...
export function RankingTypeSelector({
	...
	return (
		<div className="flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 p-4 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900">
			...
			>
				<CardHeader className="text-center">
					<CardTitle className="mb-2 animate-fade-in font-bold text-4xl text-gray-800 dark:text-gray-100">
						<span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent dark:from-blue-400 dark:to-purple-400">
							🎓 AtlasGuessr
						</span>
					</CardTitle>
					<CardDescription className="animate-fade-in-delay text-gray-600 text-lg dark:text-gray-300">
