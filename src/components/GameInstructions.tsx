	...
	return (
		<Card>
			...
			<CardContent className="space-y-2 text-gray-600 text-sm dark:text-gray-300">
				<p>• Verilen ipuçlarını kullanarak hem üniversite hem de program adını tahmin edin</p>
				...
				<p>• İpuçları: şehir, üniversite türü, burs durumu, son 4 yılın sıralamaları ve bölüm türü</p>
			</CardContent>
		</Card>
	);
}
